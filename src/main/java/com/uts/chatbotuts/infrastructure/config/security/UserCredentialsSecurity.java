...
public class UserCredentialsSecurity implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String correoElectronico) throws UsernameNotFoundException {
        ...
        UsuarioEntity usuario = usuarioJpaRepository.findByCorreoElectronico(correoElectronico).orElse(null);
        ...
        if (usuario != null) {
            ...
            listRoles.add(usuario.getRol());
            grantedAuthorities = listRoles.stream()
            ...
            Retorna un objeto `User` (implementación de `UserDetails`) con los siguientes datos:
             - correoElectronico: nombre de usuario del objeto `Usuario`.
